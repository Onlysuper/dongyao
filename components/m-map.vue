<template>
	<view class="m-map">
		<map style="width: 100%; height: 370upx;" :controls="controls" :circles="circles" :polyline='polyline' :scale="scale" :latitude="latitude" :longitude="longitude" :markers="covers">
		</map>
	</view>
</template>
